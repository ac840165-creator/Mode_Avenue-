...
"""
Script to download and update kids product images with professional fashion images
"""
...
def update_kids_images():
    ...
    with app.app_context():
        ...
        kids_image_urls = [
            ...
            "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=400&h=400&fit=crop&crop=center",  # Kids dresses
            "https://images.unsplash.com/photo-1496717675326-50322d0b2467?w=400&h=400&fit=crop&crop=center",  # Kids casual
            "https://images.unsplash.com/photo-1539008835657-9e8e9680c956?w=400&h=400&fit=crop&crop=center",  # Kids style
            "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400&h=400&fit=crop&crop=center",  # Kids formal
            "https://images.unsplash.com/photo-1608231387042-66d17730faf0?w=400&h=400&fit=crop&crop=center",  # Kids active
        ]
        ...
        for category_name, category in kids_categories.items():
            ...
            for i, product in enumerate(products_to_update):
                ...
                image_url = kids_image_urls[i % len(kids_image_urls)]
                ...
                filename = f"kids_{product_name_clean}_{product.id}.jpg"
        ...
        if total_updated > 0:
            db.session.commit()
            print(f"\n🎉 Successfully updated {total_updated} kids products with new images!")
        else:
            print("\n⚠️  No kids products were updated")
